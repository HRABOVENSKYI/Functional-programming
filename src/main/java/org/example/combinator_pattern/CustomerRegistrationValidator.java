...
import static org.example.combinator_pattern.CustomerRegistrationValidator.ValidationResult.*;
...
public interface CustomerRegistrationValidator
    ...
    static CustomerRegistrationValidator isPhoneNumberValid() {
        return customer -> customer.getPhoneNumber().startsWith("+380") ? SUCCESS : PHONE_NUMBER_NOT_VALID;
    }
